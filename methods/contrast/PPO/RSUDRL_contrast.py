...
from env.environment_contrast_our_method import RoadState
...
class Config:
    def __init__(self) -> None:
        ...
        self.env_name = 'RSU offloading decision contrast'  # 环境名称
...
def train(cfg, env, agent):
    ...
    for i_ep in range(cfg.train_eps):
        ...
        completion_rate=complete_number/(VehicularEnvConfig().time_slot_end+1)
