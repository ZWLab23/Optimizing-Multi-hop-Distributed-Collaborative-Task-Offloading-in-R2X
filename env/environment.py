...
from methods.PPO.collaborateDRL import get_collaborate_decision
import math
import numpy as np
import copy
import random
...
#####################################################未测试##############################################################
    ...
    def update_road(self):
        ...
        # 更新存活时间
            self.vehicle_list.vehicle_list[i].change_life_time()
        #更新是否发送信标的beacon
...
#     count=[]
#     for i in range(a.vehicle_number):
#         count.append(a.vehicle_list.vehicle_list[i].get_beacon_flag())
#         a.vehicle_list.vehicle_list[i].change_life_time()
#         a.vehicle_list.vehicle_list[i].change_beacon_flag()
#     print(count)
#
